...
Kirki::add_field( 'airl_theme', array(
	...
	'section'		=> 'social',
	'tooltip'		=> esc_html__( 'Font Awesome names:', 'airl' ) . ' <a href="https://fontawesome.com/icons?d=gallery&s=brands&m=free" target="_blank"><strong>' . esc_html__( 'View All', 'airl' ) . ' </strong></a>',
	'row_label'		=> array(
		'type'	=> 'text',
	...
	'fields'		=> array(
		...
		'social-icon'	=> array(
			...
			'description'	=> esc_html__( 'Font Awesome icons. Ex: fa-facebook ', 'airl' ) . ' <a href="https://fontawesome.com/icons?d=gallery&s=brands&m=free" target="_blank"><strong>' . esc_html__( 'View All', 'airl' ) . ' </strong></a>',
			'default'		=> 'fa-',
		),
		'social-link'	=> array(
			'type'			=> 'link',
