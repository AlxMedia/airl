					...
					<div class="pad group">
						...
						<div class="grid one-full">
							...
							<div id="copyright">
								...
								<?php else: ?>
									<p><?php bloginfo(); ?> &copy; <?php echo esc_html( date_i18n( esc_html__( 'Y', 'airl' ) ) ); ?>. <?php esc_html_e( 'All Rights Reserved.', 'airl' ); ?></p>
								<?php endif; ?>
							</div><!--/#copyright-->
							
							<?php if ( get_theme_mod( 'credit', 'on' ) == 'on' ): ?>
							<div id="credit">
								<p><?php esc_html_e('Powered by','airl'); ?> <a href="http://wordpress.org" rel="nofollow">WordPress</a>. <?php esc_html_e('Theme by','airl'); ?> <a href="https://agnarson.com" rel="nofollow">Alx</a>.</p>
							</div><!--/#credit-->
							<?php endif; ?>
