				...
				<div id="footer-bottom">
					...
					<div class="pad group">
						...
						<div class="grid one-full">
							...
							<div id="credit">
								<p><?php esc_html_e('Powered by','airl'); ?> <a href="http://wordpress.org" rel="nofollow">WordPress</a>. <?php esc_html_e('Theme by','airl'); ?> <a href="http://alx.media" rel="nofollow">Alx</a>.</p>
							</div><!--/#credit-->
							<?php endif; ?>
